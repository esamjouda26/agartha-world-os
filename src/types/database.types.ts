  ...
  public: {
    Tables: {
      ...
      time_slots: {
        Row: {
          ...
          constraint_type: Database["public"]["Enums"]["slot_constraint_type"] | null;
          created_at: string;
          end_time: string;
          experience_id: string;
          id: string;
    ...
    Enums: {
      ...
      disposal_reason:
        ...
        | "overproduction"
        | "quality_defect";
      employment_status: "active" | "pending" | "on_leave" | "suspended" | "terminated";
      ...
      iam_request_type: "provisioning" | "transfer" | "suspension" | "termination" | "reactivation";
      incident_category:
        | "fire"
        | "safety_hazard"
        | "biohazard"
      ...
      leave_transaction_type: "accrual" | "usage" | "adjustment" | "carry_forward" | "forfeiture";
      lifecycle_status: "draft" | "active" | "paused" | "completed";
      material_type: "raw" | "semi_finished" | "finished" | "trading" | "consumable" | "service";
      ...
      po_status: "draft" | "sent" | "partially_received" | "completed" | "cancelled";
      ...
      survey_type: "post_visit" | "nps" | "csat" | "exit_survey" | "staff_captured";
...
export const Constants = {
  public: {
    Enums: {
      ...
      incident_status: ["open", "resolved"],
      inventory_task_status: ["pending", "in_progress", "pending_review", "completed", "cancelled"],
      leave_request_status: ["pending", "approved", "rejected", "cancelled"],
      leave_transaction_type: ["accrual", "usage", "adjustment", "carry_forward", "forfeiture"],
      lifecycle_status: ["draft", "active", "paused", "completed"],
      material_type: ["raw", "semi_finished", "finished", "trading", "consumable", "service"],
