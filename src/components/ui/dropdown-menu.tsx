  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        // Popover-family glass recipe. Items inside are styled at the
        // item primitive below; they get a warm hover surface (not the
        // loud brand accent) and a gold-tint on select/check states.
        className={cn(
          "bg-card/95 text-card-foreground border-border-subtle dark:shadow-glow-brand/30 z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[10rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-xl border p-1.5 shadow-xl saturate-150 backdrop-blur-md",
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      // Item hover/focus = warm surface tint (not a loud brand accent).
      // Destructive variant keeps its red, with a brighter fg on focus.
      className={cn(
        ...
        "[&_svg:not([class*='text-'])]:text-foreground-subtle data-[variant=destructive]:*:[svg]:text-destructive!",
